...
<body>
    <main>
        ...
        <div class="Details">
            <aside class="left"> <img src="/public/images/<?= $product->getImage(); ?>"
                    alt="<?= $product->getName(); ?>">
            </aside>
            <aside class="right">
                <section class="infoDesc">
                    <h1 class="name"><?= $product->getName() ?></h1>
                    <h3><?php echo number_format($product->getPrice(), 2, ',', ' '); ?> zł</h3>
                    <span><?= $product->getDescription() ?></span>
                    <h3>Składniki</h3>
                    <span><?= $product->getIngredients() ?></span>
                </section>
                <div>

                    <div class="nutritions">
                        <h3>Wartości odżywcze (100g):</h3>
                        <section>
                            <aside class="l">
                                <span>Kalorie: <?= $product->getCals() ?> kcal</span>
                                <span>Białko: <?= $product->getProtein() ?> g</span>
                                <span>Węglowodany: <?= $product->getCarbs() ?> g</span>
                            </aside>
                            <aside class="r">
                                <span>Tłuszcze: <?= $product->getFats() ?> g</span>
                                <span>Błonnik: <?= $product->getFiber() ?> g</span>
                                <span>Sól: <?= $product->getSalt() ?> g</span>
                            </aside>
                        </section>
                    </div>
                    <div class="amount">
                        ...
                        <input class="inputAmount" type="text" value="0">
                        <button class="plus">
                            <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24"
                                fill="none">
                    ...
                    <button data-product-id="<?= $product->getId() ?>" class="addToCart"> <svg
